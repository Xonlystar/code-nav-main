...
import { EditOutlined, HeartOutlined, HeartTwoTone, LoginOutlined, ShareAltOutlined } from '@ant-design/icons'
        ...
        <Card.Meta
          avatar={
            <>
              ...
              {rate && <Rate disabled allowHalf count={rate} defaultValue={rate} className={styles.starRate} />}
            </>
          }
