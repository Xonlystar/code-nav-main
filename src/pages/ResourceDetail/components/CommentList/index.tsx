import { Avatar, Button, Comment, Form, Input, List, message, Modal, Rate, Space, Tooltip } from 'antd'
...
const CommentList: React.FC<CommentListProps> = props => {
  ...
  return (
    <div>
      ...
      >
        <Rate tooltips={rateTips} allowClear={false} value={rate} onChange={val => setRate(val)} />
              ...
              <Comment
                ...
                datetime={
                  <>
                    ...
                    <Rate allowHalf disabled className={styles.rank} count={item.rate} defaultValue={item.rate} />
                  </>
                }
              />
            </List.Item>
