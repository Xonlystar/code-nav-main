...
const ResourceDetail: FC<ResourceDetailProps> = props => {
  ...
  const actions = [
    <div onClick={() => doShare(resource)} key={1}>
      <Space>
        <ShareAltOutlined /> 分享
      </Space>
    </div>,
    <Tooltip title="一键从全网搜索资源信息" key={2}>
    ...
    <div onClick={() => setShowReportModal(true)} key={3}>
      <Space>
        <WarningOutlined /> 举报
      </Space>
    </div>
    ...
    <GridContent>
      <Row gutter={24}>
        <Col xl={16} lg={24} xs={24}>
          <Badge.Ribbon
            text={rate && <Rate disabled allowHalf count={rate} defaultValue={rate} className={styles.starRate} />}
            style={{
              padding: '0 12px',
                ...
                <div>
                  <div className={styles.avatarHolder}>
                    ...
                    <div className={styles.tagBar}>
                      <Tooltip title="浏览量">
                        <Tag icon={<EyeOutlined />} color="#aaa" style={{ marginLeft: 8, cursor: 'pointer' }}>
                          {resource.viewNum ?? 0}
                        </Tag>
                      </Tooltip>
                  ...
                  <Descriptions column={1}>
                    {resource.link && (
                      <Descriptions.Item label="链接">
                        <Typography.Paragraph copyable={{ text: resource.link }} style={{ marginBottom: 0 }}>
                    ...
                    {resource.explain && (
                      <Descriptions.Item label="秒懂">
                        <Typography.Paragraph copyable={{ text: resource.explain }} style={{ marginBottom: 0 }}>
