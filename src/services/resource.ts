 ...
 * @param pageNum
 */
export async function listResourcesByIdsByPage(resourceIds: string[], pageSize: number, pageNum: number) {
 ...
 * @param reviewMessage
 */
export async function reviewResource(resourceId: string, reviewStatus: number, reviewMessage?: string) {
